...
പ്രയോഗം മലയക്കം (വാക്യം, ഹിന്ദുഅറബിക്കിലേക്ക് = തെറ്റ്) {  
  ...
  ഇന് (ആവട്ടെ സ്ഥാനം ഇല്‍ വാക്യം) {
    ...
    // മലയാളത്തില്‍ നിന്ന് ഹിന്ദു-അറബിക്കിലേക്കാക്കാനാണോ ?
    ആണെങ്കിൽ (ഹിന്ദുഅറബിക്കിലേക്ക്) {
      ആണെങ്കിൽ (അക്കങ്ങള്‍.ന്റെസൂചിക(അക്ഷരം) !== -1) {
        മാറ്റിയവാക്യം += അക്കങ്ങള്‍.ന്റെസൂചിക(അക്ഷരം);
        തുടരുക; // അടുത്ത അക്ഷരത്തിലേക്ക് പൊക്കോ
      }
    } അല്ലെങ്കിൽ {
      // ഇത് ഒരു അക്കമാണോ ? എങ്കിൽ അത് 'അക്കങ്ങള്‍' അറെയിൽ കാ‍ണും
